...
`COO`。运营总监，负责运营流程、成本控制、效率优化，管理 PM/QM/RS/SA，汇报 CEO。
...
| Skill | 功能 | 状态 |
|-------|------|------|
| pm | project-management | 已部署 |
| qm | quality-metrics | 已部署 |
| project-management-2 | 项目管理（Eisenhower 矩阵/周规划/多阶段管理） | ✅ |
| task | 跨会话任务管理 | ✅ |
| productivity | 生产力框架（多场景） | ✅ |

## 域职责

运营流程管理、成本控制与效率优化。管理 PM（项目管理）、QM（质量管理）、RS（供应链）、SA（市场分析）。涵盖 APQP、质量体系（I6949/FMEA/PPAP）、供应链与采购管理、市场竞争分析。
